# Cohere 특허 텍스트 분석 모델 선정 보고서

> **결론: 특허 텍스트 분석에는 `command-r7b`(저비용 대량처리) 또는 `command-r`(비용 대비 성능 균형) 추천**

## Executive Summary (결론)

### 최종 모델 선정

| 용도 | 선정 모델 | Context | Max Output | Input 비용(/1M) | Output 비용(/1M) |
|------|-----------|---------|------------|-----------------|------------------|
| **대량 처리/분류** | command-r7b-12-2024 | 128K | 4K | $0.0375 | $0.15 |
| **일반 분석** | command-r-08-2024 | 128K | 4K | $0.15 | $0.60 |
| **고품질 보고서** | command-a-03-2025 | 256K | 8K | $2.50 | $10.00 |
| **복잡 추론/청구항** | command-a-reasoning-08-2025 | 256K | 32K | $2.50 | $10.00 |
...
| 용도 | 선정 모델 | 우선순위 | Context | Max Output | Input 비용(/1M) | Output 비용(/1M) |
|------|-----------|----------|---------|------------|-----------------|------------------|
| 대량 처리/분류 | command-r7b-12-2024 | 1순위 | 128K | 4K | $0.0375 | $0.15 |
| 일반 분석 | command-r-08-2024 | 2순위 | 128K | 4K | $0.15 | $0.60 |
| 고품질 보고서 | command-a-03-2025 | 필요시 | 256K | 8K | $2.50 | $10.00 |
| 복잡 추론/청구항 | command-a-reasoning-08-2025 | 필요시 | 256K | 32K | $2.50 | $10.00 |
